...
def render_ocr(mmif_id, vid_path, view_id, page_number):
    ...
    f = open(os.path.join("/app/static/tmp", mmif_id, f"{view_id}-pages.json"))
    ...
    for frame_num, frame in page:
        ...
        with tempfile.NamedTemporaryFile(
                prefix=path, suffix=".jpg", delete=False) as tf:
...
def make_image_directory(mmif_id):
    ...
    path = os.path.join("/app/static/tmp", mmif_id, "img/")
...
def save_json(dict, view_id, mmif_id):
    path = os.path.join("/app/static/tmp", mmif_id, f"{view_id}-pages.json")
